...
use super::voxel::{world_2_voxel_space, VoxelPosition, HALF_VOXEL_SIZE};
...
fn collision_depth_sphere(terrain: &Terrain, center: Vec3, radius: f32) -> Vec3 {
    ...
    {
        for potential_y in world_2_voxel_space(center.y() - radius) - 1
            ..world_2_voxel_space(center.y() + radius) + 1
        {
